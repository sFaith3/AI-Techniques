...
void SceneEvade::draw()
{
	...
	draw_circle(TheApp::Instance()->getRenderer(), (int)agents[0]->getPosition().x, (int)agents[0]->getPosition().y, agents[0]->getRadius(), 255, 0, 0, 255);
	agents[0]->draw();
	agents[1]->draw();
}
...
{
	return "Steering Behaviors :: Evade Demo";
}