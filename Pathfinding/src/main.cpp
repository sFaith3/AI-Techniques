...
void PrintInstructions() {
	cout << "Press '1' to 'Pathfinding Mouse | BFS, Dijkstra, GBFS, A*' scene" << endl;
	cout << "Press '2' to 'Multiple Locations | A*' scene" << endl;
	cout << "Press '3' to 'Enemies | Kind of D*' scene" << endl;
	cout << "Press 'F' to change between fullscreen/window" << endl;
	cout << "Press 'SPACE' to draw the agents sprite" << endl;
	cout << "Press 'ESC/Q' to exit" << endl;
}
